...
class PronosticsControllerTest < ActionController::TestCase
  ...
  test "should create pronostic" do
    assert_difference('Pronostic.count') do
      post :create, pronostic: { bet_id: @pronostic.bet_id, ligue_id: @pronostic.ligue_id, score1: @pronostic.score1, score2: @pronostic.score2, user_id: @pronostic.user_id }
    end
  ...
  test "should update pronostic" do
    patch :update, id: @pronostic, pronostic: { bet_id: @pronostic.bet_id, ligue_id: @pronostic.ligue_id, score1: @pronostic.score1, score2: @pronostic.score2, user_id: @pronostic.user_id }
    assert_redirected_to pronostic_path(assigns(:pronostic))
  end
